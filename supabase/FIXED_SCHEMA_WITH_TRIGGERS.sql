-- ============================================================================
-- COMPLETE BRAIDLY DATABASE SCHEMA WITH AUTO-ROLE-CREATION TRIGGERS
-- Run this entire script in Supabase SQL Editor
-- This creates all tables and RLS policies from scratch
-- ============================================================================
...
-- ============================================================================
-- BRAIDERS TABLE (Braider-specific data)
-- ============================================================================
...
-- ============================================================================
-- PORTFOLIOS TABLE (Braider portfolio images)
-- ============================================================================
...
-- ============================================================================
-- TRIGGERS (Auto-update updated_at + Auto-create role records)
-- ============================================================================
...
-- Auto-create braider or customer record when profile is created
CREATE OR REPLACE FUNCTION create_role_record()
RETURNS TRIGGER AS $$
BEGIN
  IF NEW.role = 'braider' THEN
    INSERT INTO braiders (id) VALUES (NEW.id) ON CONFLICT DO NOTHING;
...
CREATE TRIGGER create_role_record_trigger AFTER INSERT ON profiles
  FOR EACH ROW EXECUTE FUNCTION create_role_record();
